...
#SBATCH --time=00:30:00    	                                # walltime allocation, which has the format (D-HH:MM:SS), here set to 1 hour
#SBATCH --mem=12GB         	                                # memory required per node (here set to 4 GB)
...
Rscript code/run_simulations.R
