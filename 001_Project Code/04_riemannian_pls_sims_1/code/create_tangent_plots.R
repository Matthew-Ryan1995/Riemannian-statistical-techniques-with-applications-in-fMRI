...
get_tangent_data <- function(){
  df1 <- get_data("sample_size")
  df2 <- get_data("tangent")
  df <- bind_rows(df1, df2) %>%
    mutate(method = ifelse(is.na(method), "full", method))
...
make_plots <- function(df, var, x_type, y_type, filllab = NULL, marginal = FALSE,
...
df <- get_tangent_data()
plots_to_make <- c("marginal", "n")
goodcopy <- TRUE

walk(plots_to_make,
     function(s){
       if(s == "marginal"){
         make_plots(df = df, var = "method", x_type = "affine", y_type = "affine", marginal = TRUE,
                    filllab = "Method", savename = "method", goodcopy = goodcopy)
         make_plots(df = df, var = "method", x_type = "euclidean", y_type = "affine", marginal = TRUE,
                    filllab = "Method", savename = "method", goodcopy = goodcopy)
         make_plots(df = df, var = "method", x_type = "affine", y_type = "euclidean", marginal = TRUE,
                    filllab = "Method", savename = "method", goodcopy = goodcopy)
       }else{
         make_plots(df = df, var = "n", x_type = "affine", y_type = "affine", marginal = FALSE,
                    filllab = "n", savename = "tangent_n", goodcopy = goodcopy)
         make_plots(df = df, var = "n", x_type = "euclidean", y_type = "affine", marginal = FALSE,
                    filllab = "n", savename = "tangent_n", goodcopy = goodcopy)
         make_plots(df = df, var = "n", x_type = "affine", y_type = "euclidean", marginal = FALSE,
                    filllab = "n", savename = "tangent_n", goodcopy = goodcopy)
       }
     })
#
